...
public class InfoAdapter extends ArrayAdapter{
    ...
    public InfoAdapter(@NonNull Context context, ArrayList<Info> info) {
    ...
    //NOTE: these two methods are added to format the date and time
    /**
    ...
    //This is declared Spliting variable
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        Info currentInfo = (Info) getItem(position);

        //Find the textView in the view item.xml for the magnitude
        TextView magnitudeText = listItemView.findViewById(R.id.magnitude);
        // Format the magnitude to show 1 decimal place
        String formattedMagnitude = formatMagnitude(currentInfo.getmMagnitude());
        ...
        int magnitudeColor = getMagnitudeColor(currentInfo.getmMagnitude());
        // Set the color on the magnitude circle
        magnitudeCircle.setColor(magnitudeColor);

        // Create a new Place object
        String originalLocation = currentInfo.getmPlace();
        ...
        Date dateObject = new Date(currentInfo.getmDate());
